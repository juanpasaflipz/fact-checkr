...
async def generate_afternoon_blog_article():
...
async def generate_evening_blog_article():
...
async def generate_breaking_blog_article():
    ...
    if auto_twitter:
        try:
            ...
            if poster.is_available():
                ...
                twitter_url = await poster.post_article_async(
                    title=article.title,
                    url=blog_url,
                    excerpt=article.excerpt
                ) if hasattr(poster, 'post_article_async') else poster.post_article(
                    title=article.title,
                    url=blog_url,
                    excerpt=article.excerpt
                )
